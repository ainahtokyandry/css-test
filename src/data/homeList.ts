import takeOff from "src/assets/icons/take off.svg";
import resumeMaker from "src/assets/icons/resume maker.svg";
import recruiterFriendly from "src/assets/icons/Recruiter friendly.svg";
import beTheBest from "src/assets/icons/Be the best.svg";
import boxes from "src/assets/icons/boxes.svg";
import career from "src/assets/icons/career.svg";
import HRExperts from "src/assets/icons/HR experts.svg";
import onlineDatabase from "src/assets/icons/online database.svg";
import provenToWork from "src/assets/icons/proven to work.svg";
import response from "src/assets/icons/Response.svg";
import secure from "src/assets/icons/Secure.svg";

const homeList = [
	{
		title: "Your career can take off like a rocket!",
		content:
	...
	{
		title: "All-in-one resume maker tool",
		content:
	...
	{
		title: "Designed by HR experts, approved by recruiters",
		content:
